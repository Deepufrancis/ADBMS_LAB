...
new_role = """
CREATE USER deepu@localhost IDENTIFIED BY '1234'
"""

cursor.execute(new_role)

grant_user = """
GRANT student TO deepu@localhost
"""
...
revoke_user = """
REVOKE student FROM deepu@localhost
"""
...
select_user = """
GRANT SELECT ON faculty TO deepu@localhost
"""
